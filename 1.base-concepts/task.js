...
function calculateTotalMortgage(percent, contribution, amount, countMonths) {
  ...
  if (isNaN(contribution)) {
    return (`Параметр Сумма первоначального кредита содержит неправильное значение ${contribution}`);
  }
  ...
  if (isNaN(countMonths)) {
    return (`Параметр Срок содержит неправильное значение ${countMonths}`);
  }
